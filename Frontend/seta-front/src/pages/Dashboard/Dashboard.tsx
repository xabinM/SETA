                    ...
                    <div className="lg-container">
                        ...
                        <section className="lg-grid lg-stats" aria-label="주요 지표">
                            ...
                            <article className="lg-card lg-stat-card">
                                ...
                                <div className="lg-stat-value">1,247</div>
                                <div className="lg-stat-delta">+23개 (오늘)</div>
                            </article>
                            ...
                            <article className="lg-card lg-stat-card">
                                ...
                                <div className="lg-stat-value">₩2,480</div>
                                <div className="lg-stat-delta">+₩46 (오늘)</div>
                            </article>
                            ...
                            <article className="lg-card lg-stat-card">
                                ...
                                <div className="lg-stat-value">0.8kg</div>
                                <div className="lg-stat-delta">+0.02kg (오늘)</div>
                            </article>
                        </section>
                            ...
                            <article className="lg-card lg-detail-card">
                                ...
                                <div className="lg-center">
                                    ...
                                    <div style={{ lineHeight: 1.65 }}>
                                        ...
                                        <div className="lg-dim">(140km) 갈 수 있는</div>
                        ...
                        <section className="lg-card lg-ranking" aria-label="불용어 절약 TOP 5">
                            <div className="lg-ranking-head">
                                ...
                                <span className="lg-pill">개인 기준</span>
                            </div>
