...
export default function Chat() {
    ...
    }, [ctx.roomId, activeId, navigate]);

    const inChat = Boolean(threadId);
                        ...
                        <main className="main-chat">
                            ...
                            {!inChat ? (
                                ...
                                <div className="messages" ref={listRef}>
                                    {loadingHistory ? (
                                        <div style={{opacity: 0.6, textAlign: "center", marginTop: 24}}>히스토리 불러오는
                                            중…</div>
                                    ) : historyError ? (
                                        <div style={{
                                            opacity: 0.85,
            ...
            {ctx.open && (
              ...
              <span className="ctxitem__icon" aria-hidden>
                <svg viewBox="0 0 24 24" width="18" height="18">
                  ...
                  <path d="M4 5h16M6 5l1 14a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2l1-14" fill="none" stroke="currentColor"
