...
export default function CarModal({
    ...
    const { currentKwh, efficiency, totalKm, equivKm, progress01, pct, remainingKm } =
        useMemo(() => {
    ...
    return createPortal(
        <>
            <div className="carmodal-backdrop" onMouseDown={(e) => e.target === e.currentTarget && onClose()}>
                            ...
                            <div className="cm-tripbar">
                                ...
                                <div className="cm-meta">
                                    ...
                                    <div className="cm-chip">
                                        목표: {fmt(totalKm, "km")} ({fmt(remainingKm, "km")} 남음)
                                    </div>
                                </div>
                            </div>
                        </section>
                                ...
                                <div className="cm-cta-grid">
                                    <div className="cm-cta-copy">
                                        <div className="cm-section-head">
                                            ...
                                            <h2 id="cm-cta-title" className="cm-section-title">
                                                작지만 큰 변화
                                            </h2>
                                        </div>
