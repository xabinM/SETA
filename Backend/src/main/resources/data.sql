...
-- filter_result
INSERT INTO filter_result (trace_id, chat_room_id, message_id, stage, action, rule_name, score)
VALUES
('trace-001', (SELECT chat_room_id FROM chat_room LIMIT 1),
 (SELECT message_id FROM chat_message LIMIT 1),
 'rule', 'PASS', 'length_check', 0.95);
